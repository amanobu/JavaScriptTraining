...
describe('ステージ2（意図した通りに DOM 要素の属性・テキストを変更できるようになる）', function() {
  ...
  describe('jQuery 編', function() {
    ...
    it('9 番の要素の背景色を jQuery を使って "mediumseagreen" に変更する FireFoxではうまくいかない？', function() {
      ...
      console.log(secret('yvzrterra'));
      console.log(secret('onpxtebhaq-pbybe'));
      console.log(normalizeColor('mediumseagreen'));
      expect($element).to.be.instanceof(jQuery);

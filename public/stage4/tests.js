  ...
  describe('イベント編', function() {
    ...
    it('4 番の要素を入力された角度に回転できる', function() {
      ...
      $('input[type=number]').on('change',function(event){
        ...
        $('.turquoise').css("transform","rotate("+ num + "deg)");
      });
    ...
    it('5 番の要素の内容を取得できる', function(done) {
      ...
      //loadされてから実行されるようにこのように修正
      window.onload = function() {
        var steelblue = document.querySelector('.steelblue');
        console.log($(".steelblue"));
        console.log(document.querySelector('.steelblue'));
        console.log(document.querySelectorAll('.steelblue'));      
        console.log(document.getElementsByClassName("steelblue"));      
